import React, { useContext, createContext, useState, useMemo, useEffect, createRef, memo } from 'react';
import SbEditable from 'storyblok-react';
import { ParallaxProvider, ParallaxBanner } from 'react-scroll-parallax';
import Drawer from '@material-ui/core/Drawer';
import useMediaQuery from '@material-ui/core/useMediaQuery';
import { makeStyles, createStyles, useTheme, fade, responsiveFontSizes, createMuiTheme, ThemeProvider } from '@material-ui/core/styles';
...
import { internalLinkHandler, LmStoryblokService } from 'lumen-cms-utils';
...
function LmComponentRender(props) {
  ...
  if (typeof LmCoreComponents[content.component] !== 'undefined') {
    var CurrentElement = React.createElement(LmCoreComponents[content.component], _extends({
      content: content,
      key: typeof i === 'number' ? content.component + "_" + (content._uid || i) : undefined
    }, rest));

    if (insideStoryblok) {
      return React.createElement(SbEditable, {
        content: content
      }, CurrentElement);
    }
...
var usePageStyles = /*#__PURE__*/makeStyles(function (theme) {
...
function RightDrawer(_ref2) {
  ...
  var classes = usePageStyles();
  return React.createElement(RightDrawerContainer, null, React.createElement(ContentSpace, null), React.createElement("div", {
...
function MainContent(_ref2) {
  var body = _ref2.body;
  return React.createElement(MainContentContainer, null, body.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
...
function LmPage(_ref) {
  ...
  if (!body.some(function (i) {
    ...
    return React.createElement(React.Fragment, null, rightBody.length > 0 && React.createElement(RightDrawer, {
      rightBody: rightBody
  ...
  return React.createElement(ParallaxProvider, null, rightBody.length > 0 && React.createElement(RightDrawer, {
    rightBody: rightBody
  }), React.createElement(MainContent, {
    body: body
  }));
...
function LmTable(_ref2) {
  ...
  return React.createElement("div", {
    ...
    className: className
  }, !content.disable_table_head && React.createElement("thead", null, React.createElement("tr", null, tableHead.map(function (c, index) {
...
function LmAccordionItem(_ref) {
  ...
  }, React.createElement(Typography, null, content.title)), React.createElement(AccordionDetails, null, React.createElement("div", null, (content.body || []).map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
...
function LmHubspotMeeting(_ref) {
  ...
  }, content.meeting_name, React.createElement("div", {
...
function BackgroundImage(_ref) {
  ...
  return React.createElement(React.Fragment, null, !imgSrc && React.createElement(React.Fragment, null, React.createElement(Skeleton, {
    width: "100%",
    height: "100%",
    style: {
      position: 'absolute'
...
var LmHeadline = function LmHeadline(_ref) {
  ...
  if (content.count_end || content.count_start) {
    return React.createElement(HeadlineCountUp, {
      content: content,
      onClick: onClick
    });
  }
...
var useStyles$9 = /*#__PURE__*/makeStyles(function (_ref) {
...
function LmImageList(_ref) {
  ...
  return React.createElement("div", {
    ...
    }), React.createElement(LmComponentRender, {
      content: item,
      listProps: content
    }));
...
var LmButton = function LmButton(_ref) {
  ...
  if (content.variant === 'fab') {
    ...
    }), children || content.label, React.createElement(IconCore, {
  ...
  return React.createElement(Button, Object.assign({
    ...
    startIcon: ((_content$icon3 = content.icon) === null || _content$icon3 === void 0 ? void 0 : _content$icon3.name) ? React.createElement(IconCore, {
      iconName: content.icon.name,
      buttonSize: content.size
    }) : undefined,
    endIcon: ((_content$trailing_ico = content.trailing_icon) === null || _content$trailing_ico === void 0 ? void 0 : _content$trailing_ico.name) ? React.createElement(IconCore, {
...
function LmMenu(_ref) {
  ...
  var ExpandIcon = content.icon && content.icon.name ? React.createElement(IconCore, {
    iconName: content.icon.name
  }) : React.createElement(ChevronDown, null);
  var CloseIcon = content.icon_collapse && content.icon_collapse.name ? React.createElement(IconCore, {
    iconName: content.icon_collapse.name
  }) : React.createElement(ChevronUp, null); // const StartIcon = content.start_icon?.name ? <LmIcon iconName={content.start_icon.name} /> : null

  return React.createElement(React.Fragment, null, React.createElement(Button, {
    endIcon: anchorEl ? CloseIcon : ExpandIcon,
    startIcon: ((_content$start_icon = content.start_icon) === null || _content$start_icon === void 0 ? void 0 : _content$start_icon.name) && React.createElement(IconCore, {
    ...
    onClick: handleClick
  }, content.title), isCustom ? React.createElement(Popover, Object.assign({
  ...
  }, addons), React.createElement("div", {
    style: {
      padding: 16
    }
    ...
    return React.createElement(MenuItem, Object.assign({}, btnProps, {
...
var useStyles$g = /*#__PURE__*/makeStyles({
  videoSection: {
    position: 'relative',
    overflow: 'hidden',
    display: 'flex',
...
function LmSectionVideo(_ref) {
  ...
  })), hasBody && React.createElement("div", null, React.createElement(Container, {
    style: {
      height: '100%'
    },
    maxWidth: maxWidth
...
var CardMediaElement = function CardMediaElement(_ref) {
  ...
  return React.createElement(React.Fragment, null, !imgSource && React.createElement(React.Fragment, null, React.createElement(Skeleton, {
    style: {
      position: 'absolute'
    },
    width: "100%",
    ...
    image: imgSource,
    ref: reference
  }, !imgSource && React.createElement("div", null), children)));
};
...
var CardWrap = function CardWrap(_ref) {
  ...
  if (content.body && content.body.length) {
    return React.createElement(CardWrapWithAction, {
      className: className,
      content: content,
      style: style,
      options: options
...
function CardListActionTitles(_ref) {
  var content = _ref.content,
      options = _ref.options;
  return React.createElement(React.Fragment, null, content.title && React.createElement(Typography, {
  ...
  }, content.title), content.subtitle && React.createElement(Typography, {
...
function CardListItemActions(_ref) {
  ...
  return React.createElement(CardActions, {
...
function LmCardListItem(props) {
  ...
  if (!content.image || options.hide_image) {
    return React.createElement(CardWrap, Object.assign({}, props), React.createElement(CardActionArea, Object.assign({}, btnProps), React.createElement(CardContent, null, React.createElement(CardListActionTitles, Object.assign({}, props)), React.createElement(CardDescriptionText, Object.assign({}, props)))), React.createElement(CardListItemActions, Object.assign({}, props)));
  } // header on top


  if (variants.includes('header_top')) {
    return React.createElement(CardWrap, Object.assign({}, props), React.createElement(CardContent, null, React.createElement(CardListActionTitles, Object.assign({}, props))), React.createElement(CardActionArea, Object.assign({}, btnProps), React.createElement(CardMediaElement, Object.assign({}, props)), content.description && React.createElement(CardContent, null, React.createElement(CardDescriptionText, Object.assign({}, props)))), React.createElement(CardListItemActions, Object.assign({}, props)));
  } // header over media


  if (variants.includes('over_media')) {
    return React.createElement(CardWrap, Object.assign({}, props), React.createElement(CardActionArea, Object.assign({}, btnProps), React.createElement(CardMediaElement, Object.assign({}, props), React.createElement(CardContent, {
      style: {
        padding: variants.includes('overlay_content_no_space') ? 0 : undefined
      }
    }, React.createElement(CardListActionTitles, Object.assign({}, props)))), content.description && React.createElement(CardContent, null, React.createElement(CardDescriptionText, Object.assign({}, props)))), React.createElement(CardListItemActions, Object.assign({}, props)));
  } // content title and description bottom


  return React.createElement(CardWrap, Object.assign({}, props), React.createElement(CardActionArea, Object.assign({}, btnProps), React.createElement(CardMediaElement, Object.assign({}, props)), (content.description || content.title || content.subtitle) && React.createElement(CardContent, null, React.createElement(CardListActionTitles, Object.assign({}, props)), React.createElement(CardDescriptionText, Object.assign({}, props)))), React.createElement(CardListItemActions, Object.assign({}, props)));
}
...
var useStyles$j = /*#__PURE__*/makeStyles({
  parallax: {
    '& .parallax-inner': {
      zIndex: 0
    },
        ...
        try {
          ...
          return Promise.resolve(getImagePromise({
            ...
            return {
              ...
              children: item.children && item.children.length && React.createElement(LmComponentRender, {
...
function ListWidgetLists(_ref) {
  ...
  return React.createElement(List, null, items.map(function (item) {
    return React.createElement(Link$1, {
      ...
      component: "a"
    }, !hideImage && item.content.preview_image && React.createElement(ListItemAvatar, null, React.createElement(LmMuiAvatar, {
...
function ListWidgetContainer(props) {
  ...
  if (options.component === 'lists') {
    return React.createElement(ListWidgetLists, Object.assign({
      options: options
    }, rest));
  }

  if (options.component === 'nav_list') {
    return React.createElement(ListWidgetLinks, Object.assign({
      options: options
    }, rest));
  }

  return React.createElement(ListWidgetCards, Object.assign({
    options: options
  }, rest));
}
...
function LmListWidget(_ref) {
  ...
  return React.createElement(ListWidgetContainer, {
    options: listOption,
    content: content,
    items: items
  });
...
function LmIframeAdvanced(_ref) {
  ...
  var _useInView = useInView(intersectionIframeOptions),
      refIntersectionObserver = _useInView[0],
      inView = _useInView[1],
      containerRef = _useInView[2];

  var iframeRef = createRef(); // const [src, setSrc] = useState<string>('')
  ...
  return React.createElement("div", {
    ref: refIntersectionObserver
  }, !loaded && inView && React.createElement("div", {
    className: "p-5"
  }, React.createElement(CircularProgress, null)), React.createElement("iframe", {
...
function LmListSearchField(_ref) {
  ...
  var _useState = useState(query.search__text || ''),
...
function LmLink(_ref) {
  ...
  return React.createElement(MuiLink, Object.assign({}, btnProps, {
...
var NextComposed = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var as = _ref.as,
      href = _ref.href,
...
function Link(props) {
  ...
  var router = useRouter();
  var className = clsx(classNameProps, (_clsx = {}, _clsx[activeClassName] = (router === null || router === void 0 ? void 0 : router.pathname) === href && activeClassName, _clsx));

  if (!href) {
    // console.log(props)
    // eslint-disable-next-line jsx-a11y/anchor-has-content
    return React.createElement("a", Object.assign({}, other, {
      className: className
    }));
  }

  if (naked) {
    return React.createElement(NextComposed, Object.assign({
      className: className,
      ref: innerRef,
      href: href
    }, other));
  ...
  return React.createElement(MuiLink, Object.assign({
...
var MuiNextLink = /*#__PURE__*/React.forwardRef(function (props, ref) {
...
var ListSearchAutocompleteContainer = function ListSearchAutocompleteContainer(_ref) {
  ...
  if (isMobileAction) {
    ...
    return React.createElement(React.Fragment, null, !visible && React.createElement(IconButton, {
      onClick: onOpen
    }, ((_content$icon = content.icon) === null || _content$icon === void 0 ? void 0 : _content$icon.name) ? React.createElement(IconCore, {
      iconName: content.icon.name
    }) : React.createElement(Magnify, null)), React.createElement("div", {
      style: {
...
function LmListSearchAutocomplete(_ref2) {
  ...
  return React.createElement(ListSearchAutocompleteContainer, {
    content: content,
    popperActive: open,
    inputRef: inputRef,
      ...
      return React.createElement(TextField, Object.assign({}, params, {
        ...
        InputProps: _extends({}, params.InputProps, {
          ...
          startAdornment: React.createElement(InputAdornment, {
            position: "start"
          }, ' ', ((_content$icon2 = content.icon) === null || _content$icon2 === void 0 ? void 0 : _content$icon2.name) ? React.createElement(IconCore, {
            iconName: content.icon.name
    ...
    PaperComponent: function PaperComponent(props) {
      return React.createElement(Paper, Object.assign({}, props, {
    ...
    renderOption: function renderOption(item) {
      ...
      return React.createElement(MuiNextLink, {
        href: CONFIG.href,
        as: href,
        passHref: true,
        key: item.uuid,
...
function LmMotion(_ref) {
  ...
  return React.createElement("div", {
    ...
    }), React.createElement("div", null, (content.body || []).map(function (blok) {
      return React.createElement(LmComponentRender, {
        content: blok,
        key: blok._uid
      });
    ...
    fade: React.createElement(Fade, Object.assign({
      "in": inView
    }, transitionProps), React.createElement("div", null, (content.body || []).map(function (blok) {
      return React.createElement(LmComponentRender, {
        content: blok,
        key: blok._uid
      });
...
function LmToolbarLogo(_ref) {
  ...
  return React.createElement("div", {
    ...
    ref: refIntersectionObserver
  }, websiteLogo && settings.seo_website_url && React.createElement(LogoJsonLd, {
  ...
  }, React.createElement(React.Fragment, null, !websiteLogo && React.createElement(Typography, null, websiteTitle), websiteLogo && inView && React.createElement("img", {
  ...
  }), websiteLogoInvert && inView && React.createElement("img", {
...
function LmToggleDrawerButton(_ref) {
  ...
  return React.createElement(IconButton, {
    ...
    iconName: content.icon.name
  }) : rightDrawer ? React.createElement(AppsIcon, null) : React.createElement(MenuUi, null));
}

var useStyles$m = /*#__PURE__*/makeStyles({
  videoContainer: {
    position: 'relative'
  },
  ratio16x9: {
...
function LmToolbarSection(_ref2) {
  ...
  var body = content.body || [];
  return React.createElement(ToolbarSectionContainer, {
    content: content
  }, body.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
...
var TransitionSlideUp = /*#__PURE__*/React.forwardRef(function (props, ref) {
...
var useStyles$n = /*#__PURE__*/makeStyles({
  trigger: {
    cursor: 'pointer'
  },
  dialogTitle: {
...
function LmDialog(_ref) {
  ...
  })), React.createElement(Dialog, Object.assign({}, dialogProps), !!content.title || !content.prevent_close_button && React.createElement(DialogTitle, {
    classes: {
      root: classes.dialogTitle
    }
  }, React.createElement("span", null, content.title), !content.prevent_close_button && React.createElement(IconButton, {
    onClick: function onClick() {
      return setOpen(false);
    }
  }, React.createElement(Close, null))), content.no_padding ? React.createElement(React.Fragment, null, (_content$body = content.body) === null || _content$body === void 0 ? void 0 : _content$body.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
  })) : React.createElement(DialogContent, null, (_content$body2 = content.body) === null || _content$body2 === void 0 ? void 0 : _content$body2.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
...
var security = process.env.NODE_ENV === 'production' ? 'https' : 'http';
...
function InstagramListItem(_ref) {
  ...
  if (options.type === 'image') {
    var Social = function Social() {
      ...
      }, React.createElement("div", null, !options.hide_comments && content.commented_count > 0 && React.createElement(React.Fragment, null, React.createElement(Comment, {
        fontSize: "small"
      }), content.commented_count)), React.createElement("div", null, !options.hide_likes && content.liked_by > 0 && React.createElement(React.Fragment, null, content.liked_by, React.createElement(Heart, {
        fontSize: "small"
      }))));
    };
    ...
    }), (!options.hide_comments || !options.hide_likes) && React.createElement(GridListTileBar, {
      subtitle: React.createElement(Social, null),
      titlePosition: "top"
    }), !options.hide_description && React.createElement(GridListTileBar, {
      subtitle: content.description.split('#')[0],
      titlePosition: "bottom"
    }));
  }

  return React.createElement("div", null, React.createElement(LmInstagramPost, {
    content: {
...
var security$1 = process.env.NODE_ENV === 'production' ? 'https' : 'http';
function LmInstagramList(_ref) {
  ...
  return React.createElement("div", {
    ...
    return React.createElement(GridListTile$1, {
      key: item.shortcode,
      component: "a",
      classes: {
      ...
      target: "_blank"
    }, React.createElement(InstagramListItem, {
      content: item,
      options: content
    }));
  })));
...
var useStyles$o = /*#__PURE__*/makeStyles({
  naked: {
    padding: 0,
    boxShadow: 'none',
...
function LmTimelineItem(_ref) {
  ...
  return React.createElement(TimelineItem, null, React.createElement(TimelineOppositeContent, {
    classes: {
  ...
  })), React.createElement(TimelineSeparator, null, React.createElement(TimelineDot, {
  ...
  })), !isLast && React.createElement(TimelineConnector, null)), React.createElement(TimelineContent, null, React.createElement(Card, null, React.createElement(CardContentContainer, {
    content: content
  }, (content.title || content.subheader) && React.createElement(CardHeader, {
    title: content.title,
    subheader: content.subheader
  }), (content.body || []).length > 0 && React.createElement(CardContent, null, (_content$body = content.body) === null || _content$body === void 0 ? void 0 : _content$body.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
...
function LmSnackbar(_ref) {
  ...
  var handleAccept = function handleAccept() {
    ...
    if (!devMode && content.cookie_name) {
      Cookies.set(content.cookie_name, 'true', {
        expires: (content === null || content === void 0 ? void 0 : content.expire_in_days) || 1,
        secure: window.location ? window.location.protocol === 'https:' : true
      });
    }
  };

  return content.dialog ? React.createElement(Dialog$1, {
    open: open,
  ...
  })), React.createElement(DialogContent$1, null, ((content === null || content === void 0 ? void 0 : content.descriptions) || []).map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
  })), React.createElement(DialogActions, null, ((content === null || content === void 0 ? void 0 : content.additional_actions) || []).map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: _extends({
        color: 'secondary_text'
      }, blok),
    ...
    message: React.createElement(React.Fragment, null, ((content === null || content === void 0 ? void 0 : content.descriptions) || []).map(function (blok) {
      return React.createElement(LmComponentRender, {
        content: blok,
        key: blok._uid
      });
    })),
    action: React.createElement(React.Fragment, null, ((content === null || content === void 0 ? void 0 : content.additional_actions) || []).map(function (blok) {
      return React.createElement(LmComponentRender, {
        content: _extends({
          color: 'secondary_text'
        }, blok),
...
var useGlobalStyles = /*#__PURE__*/makeStyles(function (theme) {
...
var GlobalStyles = /*#__PURE__*/memo(function () {
  useGlobalStyles();
  return null;
});
...
var GlobalTheme = function GlobalTheme(_ref) {
  ...
  return React.createElement(ThemeProvider, {
    theme: theme
  }, React.createElement(GlobalStyles, null), React.createElement(CssBaseline, null), children);
};
...
var LmAppProvidersContainer = function LmAppProvidersContainer(_ref) {
  ...
  while (count >= 0) {
    LatestChild = React.createElement(Providers[count], {
      settings: settings
    }, LatestChild);
    count--;
  }

  return React.createElement(React.Fragment, null, LatestChild);
};
...
function useStoryblokComposer(_ref) {
  ...
  var _useState2 = useState(settings),
...
function LmApp(_ref) {
  ...
  return React.createElement(AppContainer, {
    content: appProps
  }, React.createElement(Component, Object.assign({}, appProps)));
}
...
function AppSeo(_ref) {
  ...
  if (!page) {
    return React.createElement(NextSeo, {
      title: "Not Found",
      noindex: true
    });
  }
...
var useStyles$p = /*#__PURE__*/makeStyles(function (theme) {
...
var TopAppBar = function TopAppBar(props) {
  ...
  var _useDebounce = useDebounce(isScrolledTrigger, 100),
...
function HeaderCustom(props) {
  ...
  return React.createElement(TopAppBar, Object.assign({}, props, {
    SystemBar: SystemBar
  }), rows.map(function (p) {
...
function HeaderSimple(props) {
  ...
  return React.createElement(TopAppBar, Object.assign({}, props), React.createElement(LmComponentRender, {
    content: {
      component: 'toolbar_navi_button'
    }
  }), React.createElement(LmComponentRender, {
    ...
    settings: content
  }), navRight.length > 0 && React.createElement(Grid, {
    container: true,
...
function Header(_ref) {
  ...
  if (settings.multi_toolbar && settings.multi_toolbar.length) {
    return React.createElement(HeaderCustom, {
      settings: settings
    });
  }

  return React.createElement(HeaderSimple, {
    settings: settings
  });
}
...
var useStyles$q = /*#__PURE__*/makeStyles(function (theme) {
  var _leftShift;
...
function Footer(_ref2) {
  ...
  return React.createElement(FooterContainer, null, content.map(function (blok) {
    return React.createElement(LmComponentRender, {
      content: blok,
      key: blok._uid
    });
...
function AppHead(_ref) {
  ...
  return React.createElement(NextHead, null, React.createElement("meta", {
    ...
    crossOrigin: "anonymous"
  }), CONFIG.GA && React.createElement(React.Fragment, null, React.createElement("link", {
    rel: "preconnect",
    ...
    crossOrigin: "anonymous"
  })), favicon && React.createElement(React.Fragment, null, React.createElement("link", {
    rel: "icon",
    ...
    rel: "stylesheet"
  }), settings.setup_google_site_verification && React.createElement("meta", {
    name: "google-site-verification",
    content: settings.setup_google_site_verification,
    key: "google-site-verification"
  }), insideStoryblok && React.createElement("script", {
    src: "//app.storyblok.com/f/storyblok-latest.js"
  }));
}

var AppHead$1 = /*#__PURE__*/memo(AppHead);
...
function DrawerButton(_ref) {
  ...
  return React.createElement(ListItem, Object.assign({
    button: true
  }, btnProps), buttonProps.graphic && React.createElement(ListItemIcon, null, React.createElement(IconCore, {
...
function DrawerNavList(props) {
  ...
  return React.createElement(List, {
    subheader: React.createElement(ListSubheader, null, content.header)
  }, body.map(function (blok) {
...
function DrawerContentRender(_ref) {
  ...
  if (component === 'button' || component === 'nav_menu_item') {
    return React.createElement(DrawerButton, Object.assign({}, componentProps));
  }

  if (component === 'nav_list') {
    return React.createElement(DrawerNavList, Object.assign({}, componentProps));
  }

  if (component === 'nav_menu') {
    return React.createElement(CollapsibleListSection, Object.assign({}, componentProps));
  }
...
function CollapsibleListSection(_ref2) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(ListItem, {
    button: true,
    onClick: handleClick
  }, startIconName && React.createElement(ListItemIcon, null, React.createElement(IconCore, {
  ...
  }), open ? React.createElement(ChevronUp, null) : React.createElement(ChevronDown, null)), React.createElement(Collapse, {
    "in": open,
    timeout: "auto",
    unmountOnExit: true
...
function DrawerContentList(_ref) {
  ...
  return React.createElement(React.Fragment, null, childs.map(function (props, i) {
    return DrawerContentRender({
      content: props,
      i: i
    });
...
var useStyles$r = /*#__PURE__*/makeStyles(function (theme) {
...
function DrawerElement(_ref) {
  ...
  return React.createElement(DrawerContainer, {
    ...
    elements: background.background_elements
  }), React.createElement("div", null, appSetup.drawerBelowToolbar && React.createElement(ContentSpace, null), !appSetup.hasDrawer && !appSetup.drawerBelowToolbar && React.createElement("div", null, React.createElement(Link$1, {
    href: CONFIG.href,
    as: homepageLinkHandler()
  }, React.createElement("a", null, React.createElement("div", {
    className: "p-3"
  }, !websiteLogo && websiteTitle, websiteLogo && React.createElement("img", {
    src: imageService(websiteLogo, '0x128'),
    height: "48",
    alt: websiteTitle || 'website logo'
  })))), websiteSlogan && React.createElement("div", null, websiteSlogan)), React.createElement(DrawerContentList, {
    content: settings
  })));
}

var DrawerElement$1 = /*#__PURE__*/memo(DrawerElement);
...
var Layout = function Layout(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(AppHead$1, {
    settings: settings
  }), React.createElement(Header$1, {
    settings: settings
  }), children, React.createElement(DrawerElement$1, {
    settings: settings
    ...
    return React.createElement(LmSnackbar, {
      content: blok,
      key: blok._uid
    });
...
function NotFound(_ref2) {
  ...
  useEffect(function () {
    var fetchErrorContent = function fetchErrorContent() {
      try {
        return Promise.resolve(LmStoryblokService.get(getErrorPath({
  ...
  return React.createElement(React.Fragment, null, React.createElement(NextHead, null, errorContent !== undefined && React.createElement("title", null, errorTitle), React.createElement("meta", {
    key: "robots",
    name: "robots",
    content: "noindex"
  })), React.createElement("div", {
  ...
  }), errorContent === null && React.createElement("div", null, statusCode ? React.createElement("h1", null, statusCode) : null, React.createElement("div", null, React.createElement("h2", null, title, ".")))));
}
...
function LmPagesIndex(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(AppSeo, {
    settings: settings,
    page: page,
    previewImage: page === null || page === void 0 ? void 0 : page.preview_image
  }), React.createElement(Layout, {
    settings: settings
  }, page ? React.createElement(LmComponentRender, {
    content: page
...
export { CONFIG, LmApp, AppContainer as LmAppContainer, AppProvider as LmAppProvider, AppSetupProvider as LmAppSetupProvider, LmComponentRender, LmCoreComponents, LmApp as LmDefaultApp, LmPagesIndex as LmDefaultPage, LmPage, useAppContext, useAppSetup, useScript };
//# sourceMappingURL=lumen-cms-core.esm.js.map
