/* 8011240fd43d32f050b92be462aa7820c6de1b65
 ...
 * });
 */
export declare function useProductQuery(baseOptions: Apollo.QueryHookOptions<ProductQuery, ProductQueryVariables>): Apollo.QueryResult<ProductQuery, Exact<{
    handle: string;
}>>;
export declare function useProductLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductQuery, ProductQueryVariables>): Apollo.QueryTuple<ProductQuery, Exact<{
    handle: string;
}>>;
