/* 4ed8bc5704e29d91e1e18e447116f1d8b2d64e2b
...
export declare type CheckoutCreateMutationVariables = Exact<{
    input: CheckoutCreateInput;
}>;
export declare type CheckoutCreateMutation = ({
    __typename?: 'Mutation';
} & {
...
export declare const CheckoutCreateDocument: Apollo.DocumentNode;
export declare type CheckoutCreateMutationFn = Apollo.MutationFunction<CheckoutCreateMutation, CheckoutCreateMutationVariables>;
/**
 ...
 * });
 */
export declare function useCheckoutCreateMutation(baseOptions?: Apollo.MutationHookOptions<CheckoutCreateMutation, CheckoutCreateMutationVariables>): Apollo.MutationTuple<CheckoutCreateMutation, Exact<{
    input: CheckoutCreateInput;
}>>;
export declare type CheckoutCreateMutationHookResult = ReturnType<typeof useCheckoutCreateMutation>;
export declare type CheckoutCreateMutationResult = Apollo.MutationResult<CheckoutCreateMutation>;
export declare type CheckoutCreateMutationOptions = Apollo.BaseMutationOptions<CheckoutCreateMutation, CheckoutCreateMutationVariables>;
