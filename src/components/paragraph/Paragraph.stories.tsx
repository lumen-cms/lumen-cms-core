      ...
      content: [
        {
          type: 'list_item',
          content: [
            { type: 'paragraph', content: [{ text: 'first', type: 'text' }] }
          ]
        },
        {
          type: 'list_item',
          content: [
            { type: 'paragraph', content: [{ text: 'second', type: 'text' }] }
          ]
        },
        {
          type: 'list_item',
          content: [
            { type: 'paragraph', content: [{ text: 'third', type: 'text' }] }
          ]
        }
      ]
    },
      ...
      content: [
        {
          ...
          marks: [
            {
              type: 'styled',
              attrs: { class: 'badge badge-pill badge-primary' }
            }
          ]
        }
      ]
...
export const RichTextParagraph = () => (
  <>
    <LmParagraph
      content={{ _uid: '12', component: 'rich_text_editor', body: rte }}
    />
  </>
)
