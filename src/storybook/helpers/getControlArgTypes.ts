...
type GetArgTypesProps = {
  componentName: string, options?: any, knob?: string, count?: number | string
}

export const getControlArgTypes = ({ componentName, options = {}, knob, count = '' }: GetArgTypesProps) => {
  ...
  Object.keys(schema).forEach(schemaKey => {
    ...
    } else if (['bloks', 'section', 'tab', 'richtext', 'multilink', 'file'].includes(type)) {
      // do nothing
    } else {
