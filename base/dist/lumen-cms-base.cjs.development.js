...
var StoryblokClient = _interopDefault(require('storyblok-js-client'));
...
var defaultValue = {
  ...
  ComponentRender: function ComponentRender(_blok) {
    return React__default.createElement("div", null, "needs to be set");
  }
};
...
function LmTable(_ref2) {
  ...
  return React__default.createElement("table", {
    className: className
  }, !content.disable_table_head && React__default.createElement("thead", null, React__default.createElement("tr", null, tableHead.map(function (content, index) {
...
function LmHeadline(_ref) {
  ...
  }, !!content.text_xs && React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
    className: "d-none d-sm-block"
  }, content.text), React__default.createElement("span", {
    className: "d-block d-sm-none"
  }, content.text_xs)), React__default.createElement(React__default.Fragment, null), !content.text_xs && content.text);
}
...
var WindowDimensionsCtx = /*#__PURE__*/React.createContext(defaultWindowsProvider);
...
function BackgroundImage(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, !imgSrc && React__default.createElement(Skeleton, {
    width: '100%',
    height: '100%',
    style: {
      position: 'absolute'
...
function LmButton(_ref) {
  ...
  if (content.variant === 'fab') {
    ...
    }), content.label, React__default.createElement(IconCore, {
  ...
  return React__default.createElement(Button, Object.assign({
    ...
    startIcon: React__default.createElement(IconCore, {
      iconName: content.icon && content.icon.name,
      buttonSize: content.size
    }),
    endIcon: React__default.createElement(IconCore, {
      iconName: content.trailing_icon && content.trailing_icon.name,
      buttonSize: content.size
    })
  }), content.image && React__default.createElement(LmMuiAvatar, {
...
var useStyles$b = /*#__PURE__*/styles.makeStyles({
  carousel: {
    position: 'relative',
    '& [data-swipeable="true"]': {
      overflow: 'hidden',
...
function LmSectionVideo(_ref) {
  ...
  })), hasBody && React__default.createElement("div", null, body.map(function (blok, i) {
    return ComponentRender({
      content: blok,
      i: i
    });
...
function LmMotion(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    }), React__default.createElement("div", null, (content.body || []).map(function (blok, i) {
      return ComponentRender({
        content: blok,
        i: i
      });
    ...
    'fade': React__default.createElement(Fade, Object.assign({
      "in": inView
    }, transitionProps), React__default.createElement("div", null, (content.body || []).map(function (blok, i) {
      return ComponentRender({
        content: blok,
        i: i
      });
...
var useStyles$i = /*#__PURE__*/styles.makeStyles({
  fullHeight: {
    width: '100%',
    height: '100%',
    minHeight: '100vh'
...
function LmAccordionItem(_ref) {
  ...
  }, React__default.createElement(Typography, null, content.title)), React__default.createElement(ExpansionPanelDetails, null, React__default.createElement("div", null, (content.body || []).map(function (blok, i) {
    return ComponentRender({
      content: blok,
      i: i
    });
...
var useStyles$j = /*#__PURE__*/styles.makeStyles(function (theme) {
  return styles.createStyles({
    cardContainer: {
      position: 'relative',
...
function TimelineRowItem(_ref2) {
  ...
  }), React__default.createElement(Card, null, React__default.createElement(CardContentContainer, {
    content: content
  }, (content.title || content.subheader) && React__default.createElement(CardHeader, {
    title: content.title,
    subheader: content.subheader
  }), body.length > 0 && React__default.createElement(CardContent, null, body.map(function (blok, i) {
    return ComponentRender({
      content: blok,
      i: i
    });
...
function LmTimelineItem(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Grid, {
    ...
    xs: 8,
    sm: 5
  }, (iteration % 2 === 0 || isMobile) && React__default.createElement(TimelineRowItem, {
    isLeft: true,
    content: content
  })), React__default.createElement(Grid, {
    item: true,
  ...
  }, iteration % 2 !== 0 && React__default.createElement(TimelineRowItem, {
    isLeft: false,
    content: content
  })));
}
...
function LmImageListItem(props) {
  ...
  if (inView && content.source && (currentRef === null || currentRef === void 0 ? void 0 : currentRef.target)) {
    ...
    if (!width) {
      return React__default.createElement("span", null, "some error with image list item");
    }
...
var useStyles$l = /*#__PURE__*/styles.makeStyles({
  videoContainer: {
    position: 'relative'
  },
  ratio16x9: {
...
var deviceDetect = function deviceDetect(req) {
  ...
  var mobileDevice = isMobile.isMobile({
    ua: userAgent
  });
  var tabletDevice = isMobile.isMobile({
    ua: userAgent,
    tablet: true
  });
  var obj = {
...
var WindowDimensionsProvider = function WindowDimensionsProvider(_ref) {
  ...
  var _useState = React.useState(defaultWindowsProvider),
  ...
  return React__default.createElement(WindowDimensionsCtx.Provider, {
    value: dimensions
  }, children);
};
...
exports.LmStoryblokService = StoryblokService;
exports.LmTable = LmTable;
exports.LmTabs = LmTabs;
exports.LmTimeline = LmTimeline;
exports.LmWindowDimensionProvider = WindowDimensionsProvider;
exports.internalLinkHandler = internalLinkHandler;
