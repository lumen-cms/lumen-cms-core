...
export declare type ComponentRenderProps = FunctionComponentFactory<ComponentRenderFuncProps>;
export declare type LinkRenderProps = FunctionComponentFactory<any>;
export {};
