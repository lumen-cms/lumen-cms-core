...
import { LmAppContainer, LmComponentRender, LmCoreComponents } from 'lumen-cms-core'
...
import { LmFastSpringProvider } from '../src/components/fastspring/LmFastspringProvider'
import { LmEcommerceCheckout } from '../src/components/EcommerceCheckout'
import { LmFastSpringCheckout } from '../src/components/fastspring/LmFastSpringCheckout'

const storefront = 'insidesoccer.test.onfastspring.com/popup-insidesoccer'
const accessKey = 'KZY-IFBBTXUW8QJ_WCGFGG'
const url = 'https://d1f8f9xcsvx3ha.cloudfront.net/sbl/0.8.3/fastspring-builder.min.js'
      ...
      <div style={{ marginBottom: 16 }}>
        <LmComponentRender content={{
          ...
          trigger: [{
            ...
            source: 'https://a.storyblok.com/f/82895/1280x1044/d20df0f536/buy-now-606685_1280.png'
          } as ImageStoryblok]
        } as EcommerceCheckoutStoryblok} />
      </div>
      <div style={{ marginBottom: 16 }}>
...
export const DisplayText = () => (
  <div style={{ textAlign: 'center' }}>
    <div style={{ marginBottom: 16 }}>
      <div dangerouslySetInnerHTML={{ __html: 'Following terms available: {discount} {total} {price}' }}></div>
      <LmComponentRender content={{
        _uid: '123',
        component: 'ecommerce_checkout',
        integration: [{ ...integration, text_only: true } as EcommerceFastspringProductStoryblok],
        trigger: [{
          _uid: '2432',
          component: 'headline',
